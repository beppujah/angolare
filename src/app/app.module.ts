...
@NgModule({
  declarations: [
    ...
    ThreedComponent,
    TwodComponent,
    RietveldHandsComponent,
    FridoComponent,
    PolarComponent,
    OldComponent,
    PortraitsComponent,
    DenDolderDigitalComponent,
    DenDolderAnalogComponent,
    PhotogramsComponent,
    VideoComponent,
    PhotoComponent,
    BooksComponent,
    CollagesComponent,
    SomehowPurechanceComponent,

    DuoComponent,
    DogspottingComponent,
    AlohaComponent,
    AnoukComponent,
    KirasComponent,
    EfdeComponent,
    ...
    HijmaComponent,
    RomeroComponent,
    FreeAssociationComponent,
    HealersComponent,
    SkullComponent,
    MapaComponent,
    ShoppingMallComponent,
    FleurComponent,
    MixedReferencesComponent,
    EncounterComponent,
    DirtyprojectionComponent,
    FirebubblesComponent,
    LandscapeComponent,
    MachinesComponent,
    AntiroutineComponent,
    HandlesComponent,
    DenDolderComponent,
    TemporaryComponent,
